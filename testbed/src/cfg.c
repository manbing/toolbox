...
static struct uci_package *uci_testbed;
                	  ...
                	  struct vlist_node *node_old)
{
        ...
        if (node_old && node_new) {
                printf("[%s:%d] Update name from %s to %s\n", __func__, __LINE__, old->name, new->name);
                printf("[%s:%d] Update age from %d to %d\n", __func__, __LINE__, old->age, new->age);
                ...
                printf("[%s:%d] Remove %s, age %d\n", __func__, __LINE__, old->name, old->age);
				free(old->name);
				free(old);
        } else if (node_new) {
                printf("[%s:%d] Create %s, age %d\n", __func__, __LINE__, new->name, new->age);
        }
}
